            ...
            if not db.query(Brand).filter(Brand.name == b_data["name"]).first():
                ...
                db.add(
                    Brand(
                        ...
                        inn=b_data.get("inn"),
                        contact_phone=b_data.get("contact_phone"),
                        tax_system=b_data.get("tax_system"),
                        vat_payer=b_data.get("vat_payer"),
                        vat_rate=b_data.get("vat_rate"),
                        ogrn=b_data.get("ogrn"),
