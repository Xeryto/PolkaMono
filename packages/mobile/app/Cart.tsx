...
const CartItemImage = ({ item }: { item: CartItem }) => {
  ...
  return (
    <View style={styles.container}>
      <Image source={item.images && item.images.length > 0 ? item.images[0] : require('./assets/Vision.png')} style={[styles.itemImage, { aspectRatio }]} resizeMode="contain" onLoad={onImageLoad} />
    </View>
  );
};
