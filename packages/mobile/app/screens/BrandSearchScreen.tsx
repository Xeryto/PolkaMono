...
const BrandSearchScreen: React.FC<BrandSearchScreenProps> = ({
  ...
  useEffect(() => {
    if (isSearchActive) {
      searchResultsHeight.value = withTiming(height * 0.35, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
      searchResultsOpacity.value = withTiming(1, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
      bubblesHeight.value = withTiming(height * 0.125, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
    } else {
      searchResultsHeight.value = withTiming(height * 0.125, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
      searchResultsOpacity.value = withTiming(0, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
      bubblesHeight.value = withTiming(height * 0.2, {
        duration: ANIMATION_DURATIONS.STANDARD,
      });
    }
  }, [isSearchActive]);
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          ...
          <Animated.View style={styles.textContainer}>
            <Text style={styles.text}>БРЕНДЫ</Text>
          </Animated.View>
        </Animated.View>
      </SafeAreaView>
    </LinearGradient>
